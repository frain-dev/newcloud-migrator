...
import (
	...
	configCmd "github.com/frain-dev/newcloud-migrator/convoy-23.9.2/cmd/config"
	"github.com/frain-dev/newcloud-migrator/convoy-23.9.2/cmd/hooks"
	"github.com/frain-dev/newcloud-migrator/convoy-23.9.2/cmd/ingest"
	"github.com/frain-dev/newcloud-migrator/convoy-23.9.2/cmd/migrate"
	"github.com/frain-dev/newcloud-migrator/convoy-23.9.2/cmd/retry"
	"github.com/frain-dev/newcloud-migrator/convoy-23.9.2/cmd/scheduler"
	"github.com/frain-dev/newcloud-migrator/convoy-23.9.2/cmd/stream"
	"github.com/frain-dev/newcloud-migrator/convoy-23.9.2/cmd/version"
	"github.com/frain-dev/newcloud-migrator/convoy-23.9.2/cmd/worker"
	"github.com/frain-dev/newcloud-migrator/convoy-23.9.2/database/postgres"
	"github.com/frain-dev/newcloud-migrator/convoy-23.9.2/ee"
	"github.com/frain-dev/newcloud-migrator/convoy-23.9.2/ee/cmd/domain"
	"github.com/frain-dev/newcloud-migrator/convoy-23.9.2/ee/cmd/server"
